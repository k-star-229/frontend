...
import { login } from '../../../actions/masterAuth';

const MasterSignIn = ({ login, isAuthenticated }) => {
            ...
            <div className='d-flex flex-column'>
                ...
                <div className='d-flex justify-content-center' >
                    <Form style={{width: "500px"}} noValidate validated={validated} onSubmit={handleSubmit}>
                        ...
                        <p className="my-1">
                            Don't have an account? <Link to="/master/signup">Create One</Link>
                        </p>
                    </Form>
                </div>
            </div>
...
export default connect(mapStateToProps, { login })(MasterSignIn);