...
const AdminSignUp = ({ setAlert, register, isAuthenticated }) => {
    ...
    return (
        <section className=''>
            ...
            <br />
            <h1 className='text-center'>A d m i n</h1>
            <hr />
            <br />
            <br />
...
export default connect(mapStateToProps, { setAlert, register })(AdminSignUp);